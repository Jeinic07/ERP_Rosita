...
public class InventarioPanelInfo extends JFrame {
	...
	public InventarioPanelInfo() {
		...
		imagenBg = new ImageIcon("src/main/java/co/edu/unbosque/view/images/InfoInv.png").getImage();
