...
public class ComprasPanelInfo extends JFrame {
	...
	public ComprasPanelInfo() {
		...
		imagenBg = new ImageIcon("src/main/java/co/edu/unbosque/view/images/InfoCompras.png").getImage();
